...
/// 加密错误
pub const MV_E_ENCRYPT: u32 = 0x8000000E;
/// 打开文件出现错误
pub const MV_E_OPENFILE: u32 = 0x8000000F;
/// 缓存地址已使用
pub const MV_E_BUF_IN_USE: u32 = 0x80000010;
/// 无效的缓存地址
pub const MV_E_BUF_INVALID: u32 = 0x80000011;
/// 缓存对齐异常
pub const MV_E_NOALIGN_BUF: u32 = 0x80000012;
/// 缓存个数不足
pub const MV_E_NOENOUGH_BUF_NUM: u32 = 0x80000013;
/// 串口被占用
pub const MV_E_PORT_IN_USE: u32 = 0x80000014;
/// 解码错误(SDK校验图像异常)
pub const MV_E_IMAGE_DECODEC: u32 = 0x80000015;
/// 图像大小超过unsigned int返回，接口不支持
pub const MV_E_UINT32_LIMIT: u32 = 0x80000016;
/// 图像高度异常（残帧丢弃）
pub const MV_E_IMAGE_HEIGHT: u32 = 0x80000017;
/// 未知的错误
...
/// 在固定IP模式下不支持修改设备IP模式
pub const MV_E_SUPPORT_MODIFY_DEVICE_IP: u32 = 0x8000020E;
/// 秘钥校验错误
pub const MV_E_KEY_VERIFICATION: u32 = 0x8000020F;
/// 设备IP冲突
